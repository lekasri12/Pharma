...
<body>
    ...
    <div class="collapse navbar-collapse" id="navbarSupportedContent">
      <ul class="navbar-nav mr-auto">
        <li class="nav-item active">
          <a class="nav-link" href="medi.html">Home <span class="sr-only">(current)</span></a>
        </li>
        <li class="nav-item">
  ...
  <footer class="bg-dark text-white text-center py-4 mt-5">
    <p>&copy; 2024 PharmaCompany. All rights reserved. BY LEKASRI(212223100025)</p>
  </footer>
  ...
  <div class="container mt-5">
    <div class="row">
      <div class="col-md-12">
        ...
        <div class="card-deck">
          <div class="card">
            <img src="image.png" class="card-img-top" alt="Product 1" width="200" height="250">
            <div class="card-body">
          ...
          <div class="card">
            <img src="tab.png" class="card-img-top" alt="Product 2" width="200" height="200">
            <div class="card-body">
          ...
          <div class="card">
            <img src="p3.png" class="card-img-top" alt="Product 3" width="200" height="200">
            <div class="card-body">
...
## OUTPUT:
![alt text](<Screenshot 2024-05-13 103815.png>)
![alt text](<Screenshot 2024-05-13 103827.png>)
![alt text](<Screenshot 2024-05-13 103840.png>)
![Screenshot 2024-05-13 104416](https://github.com/lekasri12/Pharma/assets/149037427/8cce17a5-86ff-4773-9f03-6defb3ce3fbc)
